          ...
          <Card bg='dark' text='white' className="p-4 text-center" style={{borderRadius: '1rem'}}>
            <Card.Body className="mb-md-5 mt-md-4 pb-1">
              ...
              <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Form.Group className="form-outline form-white mb-4">
                  <Form.Control className="form-control form-control-lg" type='text' {...register('correo', {
                     pattern: {
                ...
                <Form.Group className="form-outline form-white mb-4">
                  <Form.Control className="form-control form-control-lg" type='password' {...register('contraseña')} required placeholder="Contraseña" />
                </Form.Group>
